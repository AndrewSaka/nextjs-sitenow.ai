...
const plans = [
  {
    ...
    description: "Try sitenow.ai risk-free. No commitment.",
    credits: "50 credits included",
    cta: "Start Free Trial",
    ctaStyle: "outline" as const,
    featured: false,
    chooseIf: [
      "Want to see your website built with AI",
      "Are evaluating tools for your business",
      "Want to try before you commit",
    ],
    includes: [
      "1 full-stack AI-generated website",
      "WordPress backend & CMS included",
  ...
  },
  {
    ...
    period: "/mo",
    description: "Everything you need to launch a real website with AI.",
    ...
    chooseIf: [
      ...
      "Are launching a business or portfolio",
    ],
    includes: [
      "Everything from the free tier",
      "Up to 2 published sites",
      "2 custom domains",
  ...
  },
  {
    ...
    period: "/mo",
    description: "For professionals and small teams running multiple sites.",
    credits: "1,200 credits / mo",
    cta: "Get Business",
    ctaStyle: "primary" as const,
    featured: true,
    chooseIf: [
      "Manage multiple client or business sites",
      "Want advanced WordPress customization",
      "Need fast, priority support",
    ],
    includes: [
      "Everything in Pro",
      "Up to 5 published sites",
      "5 custom domains",
  ...
  },
  {
    ...
    description: "For businesses with custom needs. Let's talk.",
    credits: "Custom volume pricing",
    cta: "Contact Us",
    ctaStyle: "outline" as const,
    featured: false,
    chooseIf: [
      "Need custom development or integrations",
      "Want a tailored solution for your business",
      "Require dedicated support and SLAs",
    ],
    includes: [
      "Everything in Business",
      "Unlimited sites & custom domains",
      "Custom development by our team",
...
const pricingFaqs = [
  ...
  },
  {
    ...
    a: "Yes! Switch to annual billing and save 20% on Pro and Business plans. That's like getting over two months free every year.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      <div className="sticky top-0 z-50">
        <div className="bg-[#14151f] text-white text-center py-2 px-4 text-[12px] md:text-[13px] font-semibold tracking-wide leading-snug">
          <span className="hidden md:inline">Sign up now for early adopter pricing. Prices increase soon.</span>
          <span className="md:hidden">Sign up now. Prices go up soon.</span>
        </div>
