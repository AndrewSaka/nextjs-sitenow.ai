...
const prompts: Prompt[] = [
  { text: "Site for an Italian trattoria in Rome", kind: "restaurant", image: { desktop: "/pasta_screenshot_desktop.png", mobile: "/pasta_screeshot_mobile.png" } },
  { text: "Landing page for a Series A cold storage SaaS", kind: "saas", image: { desktop: "/icevault_screenshot_desktop.png", mobile: "/icevault_screeshot_mobile.png" } },
  ...
  { text: "Site for a Copenhagen interior designer", kind: "studio", image: { desktop: "/architecture_screenshot_desktop.png", mobile: "/architecture_screeshot_mobile.png" } },
  { text: "Landing page for project management courses", kind: "saas", image: { desktop: "/project_management_screenshot_desktop.png", mobile: "/project_management_screeshot_mobile.png" } },
  { text: "Portfolio site for a Paris-based photographer", kind: "studio", image: { desktop: "/paris_screenshot_desktop.png", mobile: "/paris_screeshot_mobile.png" } },
  { text: "Bookings site for a Viking cafe in Stockholm", kind: "restaurant", image: { desktop: "/viking_screenshot_desktop.png", mobile: "/viking_screeshot_mobile.png" } },
  { text: "Site for a small bakery with online ordering", kind: "bakery", image: { desktop: "/cake_screenshot_desktop.png", mobile: "/cake_screeshot_mobile.png" } },
];
